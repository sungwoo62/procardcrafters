          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                <div className="font-semibold text-blue-800 text-sm mb-1">Global Production</div>
                <div className="text-blue-600 text-xs leading-relaxed">Premium presses across our global production network</div>
              </div>
