...
const TYPOGRAPHY = [
  ...
  { label: 'Body Large', cls: 'text-lg text-gray-600', sample: 'Global production, delivered worldwide with FedEx.' },
            ...
            <div className="border border-gray-200 rounded-2xl overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-8 py-10 text-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-3 leading-tight">
                  Premium Print,{' '}
                  <span className="text-blue-600">Delivered Worldwide</span>
                </h2>
