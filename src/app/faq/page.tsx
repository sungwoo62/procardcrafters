...
const FAQS = [
  {
    ...
    a: 'All products are printed using professional-grade equipment and premium materials at our global production network, then shipped worldwide with FedEx.',
  },
  {
