...
// 링크 편집·검증·고객숨김 토글은 어드민 전용 도구(/admin/reports/swadpia-mapping)로 분리했다.
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-10">
      ...
      <p className="mt-1 text-sm text-gray-500">
        ...
        링크 편집·라이브 검증·고객숨김 토글은 어드민 전용 도구에서 수행합니다.
      </p>
                ...
                return (
                  <div key={item.slug} className="flex flex-wrap items-center gap-2 rounded-lg border border-gray-200 p-3">
                    ...
                    {row.hidden_from_customer && (
                      <span className="rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-500">고객숨김</span>
                    )}
